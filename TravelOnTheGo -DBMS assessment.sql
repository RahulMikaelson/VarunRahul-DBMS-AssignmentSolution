...
use TravelOnTheGo;
create table passenger (passenger_name varchar(50), category varchar(50), gender varchar(50), boarding_city
...
where P.bus_type = 'Sitting' and P.distance = 1000; 
 /*no one has travelled 1000km by sitting type bus as per given data*/
